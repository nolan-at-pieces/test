!function(){
  ...
  // Other functions (for completeness) remain unchanged.
  ...
  function injectAll(){
    ...
    bqs.forEach(function(bq){
      ...
      // Match if the text equals any of the known keywords.
      var isMatch = (
        "all"===l || "dual"===l || "intel"===l || "windows"===l ||
        "linux"===l || "arm"===l || "pkg"===l ||
        "download-mac-all"===l ||
